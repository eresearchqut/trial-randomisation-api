...
- n_of_1 - Code for the application's n_of_1 trial randomisation function.
...
```bash
aws cloudformation delete-stack --stack-name trial-randomisation-api
```


## Building with a Python Virtual Env

Requirements

* PyEnv - [pyenv](https://github.com/pyenv/pyenv)
* PyEnv VirtualEnv [pyenv-virtualenv](https://github.com/pyenv/pyenv-virtualenv)
